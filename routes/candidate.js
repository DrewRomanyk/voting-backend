...
const requiredProperties = ["name", "party_id", "date_of_birth", "submit_status"];
...
router.patch('/:id', (req, res) => {
    ...
    db.one('UPDATE voterapp.candidate SET "name" = ${name}, party_id = ${party_id}, date_of_birth = ${date_of_birth}, website_url = ${website_url}, submit_status = ${submit_status} WHERE id = ${id} RETURNING *', {
        name: req.body.name,
